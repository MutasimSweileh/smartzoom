(function ($) {
	...
	if ($('.menu-area li.menu-item-has-children ul').length) {
		$('.menu-area .navigation li.menu-item-has-children').append('<div class="dropdown-btn"><span class="fal fa-angle-down"></span></div>');
...
/*
jQuery(".slider_area").owlCarousel({
		items: 1,
		itemsDesktop: [1024, 1],
