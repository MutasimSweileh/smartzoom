...
$myorder = array();
if ($del)
    $core->SqlDel("mag", "where id=" . $del);
if (!$add && !$edit) {
?>
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-primary" style="text-transform: capitalize;float: right;"> المجلة</h6>
            <div class="d-sm-flex align-items-center justify-content-between " style="float: left;">
                <div class="form-groupd col2">
                    <a href="?app=<?= $app ?>&add=true" class="btn btn-success btn-icon-split">
                        ...
                        <span class="text">اضافة عدد</span>
                    </a>
                </div>
            </div>
            <div class="clear"></div>
...
<?php } else {
    if ($edit)  $myorder = $core->getmag(array("id" => $edit));  ?>
    <div class="card shadow mb-4">
        <div class="card-header py-3">
                ...
                <div class="row">
                    ...
                    <div class="form-group col">
                        ...
                        <div class="input-group mb-3">
                            <input type="text" name="file" class="form-control" value="<?= $myorder[0]["file"] ?>">
                            <div class="input-group-append">
                                <input name="fileToUpload2" accept="*/*" class="fileToUpload photo upload-field-1" type="file">
                                <button class="btn btn-success uploadFile" type="button">اختيار الملف</button>
                            </div>
                        </div>
                    </div>
                </div>
